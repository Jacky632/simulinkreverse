###########################################################################
## Makefile generated for component 'process_PIConstrained'. 
## 
## Makefile     : process_PIConstrained.mk
## Generated on : Wed Jul 08 14:58:06 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/process_PIConstrained
...
PRODUCT_NAME              = process_PIConstrained
MAKEFILE                  = process_PIConstrained.mk
MATLAB_ROOT               = /Applications/MATLAB_R2024a.app
MATLAB_BIN                = /Applications/MATLAB_R2024a.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maca64
START_DIR                 = /Users/jacky/Library/CloudStorage/OneDrive-Personal/Cam\ 2025/GF1/Week\ 2\ Models
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/process_PIConstrained
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/process_PIConstrained_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=process_PIConstrained -DNUMST=2 -DNCSTATES=5 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/process_PIConstrained_grt_rtw/process_PIConstrained.c $(START_DIR)/process_PIConstrained_grt_rtw/process_PIConstrained_data.c $(START_DIR)/process_PIConstrained_grt_rtw/rt_nonfinite.c
...
OBJS = rt_logging.o process_PIConstrained.o process_PIConstrained_data.o rt_nonfinite.o
...
%.o : $(START_DIR)/process_PIConstrained_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/process_PIConstrained_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/process_PIConstrained_grt_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/process_PIConstrained_grt_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/process_PIConstrained_grt_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
process_PIConstrained.o : $(START_DIR)/process_PIConstrained_grt_rtw/process_PIConstrained.c
	$(CC) $(CFLAGS) -o "$@" "$<"


process_PIConstrained_data.o : $(START_DIR)/process_PIConstrained_grt_rtw/process_PIConstrained_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/process_PIConstrained_grt_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
