...
% Layout strategy: Hierarchical.
% Layout note: Rows follow recovered Simulink source hierarchy; dependency depth still moves signals from left to right within each hierarchy band.
% Inferred facts are represented as blocks, lines, and annotations.

model = 'reconstructed_model_layout1_hierarchical';
originalModelName = 'process_PIConstrained';
layoutStrategy = 'Hierarchical';
layoutDescription = 'Rows follow recovered Simulink source hierarchy; dependency depth still moves signals from left to right within each hierarchy band.';
...
try
    ann = Simulink.Annotation(model, 'Layout strategy: Hierarchical. Rows follow recovered Simulink source hierarchy; dependency depth still moves signals from left to right within each hierarchy band.');
